...
air_3268 g_air_3268[g_channels];
#define g_radio g_air_3268[index]
...
{
    return air_3268::set_init_callback(callback);
}
...
int32_t radio::init()
{
    ...
    air_3268::set_en_expt(true);

    LM(air_3268::_init_callback(),"error");
    ...
    for (uint32_t i = 0;i < channels();++i) {
        g_air_3268[i].set_rf_idx(i);
        g_air_3268[i].connect(serial);
        g_air_3268[i].open_board();
    }
