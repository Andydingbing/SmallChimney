...
int32_t (*air_3268::_init_callback)() = nullptr;
bool air_3268::_en_expt = false;
logger_com air_3268::g_log;
...
void air_3268::set_init_callback(int32_t (*init_callback)())
{
    _init_callback = init_callback;
}

void air_3268::set_en_expt(const bool en)
{
    air_3268::_en_expt = en;
}

int32_t air_3268::wpi(serial_dev *serial)
{
...
bool air_3268::connect(const serial_dev *serial)
{
    _serial = const_cast<serial_dev *>(serial);
    return true;
}

bool air_3268::is_connected()
{
    return _serial != nullptr;
}

int32_t air_3268::tx(const uint64_t freq)
{
...
int32_t air_3268::set_tx_freq(const uint64_t freq)
{
    return tx(freq);
}

int32_t air_3268::txon() const
{
    SERIAL_W("txon");
    return 0;
}

int32_t air_3268::txoff() const
{
    SERIAL_W("txoff");
    return 0;
}

int32_t air_3268::txstepattmain(const double att) const
{
    SERIAL_W(fmt::format("txstepattmain -b {:c} {:d}",rf_idx(),uint32_t(att * 10)));
    return 0;
}

int32_t air_3268::txattmain(const uint32_t dac) const
{
    SERIAL_W(fmt::format("txattmain -b {:c} att {:d}",rf_idx(),dac));
    return 0;
}

int32_t air_3268::pabias() const
{
    SERIAL_W(fmt::format("pabias -b {:c}",rf_idx()));
    return 0;
}

int32_t air_3268::pacm() const
{
    SERIAL_W(fmt::format("pacm -b {:c}",rf_idx()));
    return 0;
}

int32_t air_3268::txtype(const ns_air_3268::tx_type_t &type) const
{
...
int32_t air_3268::rxrfsw(const bool en_lna,const bool en_att)
{
...
int32_t air_3268::rxrfvga(const double att) const
{
    SERIAL_W(fmt::format("rxrfvga {:lld}",uint32_t(att)));
    return 0;
}

int32_t air_3268::rxrfvgaswp(const std::string &str,ns_air_3268::data_f_rx_rf_vga *data) const
{
    string write;
    string read;
    string separator = "\r\n";
...
int32_t air_3268::rxagc(const bool en) const
{
    SERIAL_W(en ? "rxagc 1" : "rxagc 0");
    return 0;
}

int32_t air_3268::rx(const uint64_t freq)
{
...
int32_t air_3268::set_rx_freq(const uint64_t freq)
{
    return rx(freq);
}

int32_t air_3268::rxtype(const ns_air_3268::rx_type_t &type) const
{
    string str_type = type._to_string();
    boost::to_lower(str_type);
...
int32_t air_3268::biasctrl(const bool en) const
{
    SERIAL_W(en ? "biasctrl 1" : "biasctrl 0");
    return 0;
}

int32_t air_3268::ccctrl(const bool en) const
{
    SERIAL_W(en ? "ccctrl 1" : "ccctrl 0");
    return 0;
}

int32_t air_3268::rxcpriconf() const
{
    SERIAL_W(fmt::format("rxcpriconf -b {:c}",rf_idx()));
    return 0;
}

int32_t air_3268::iqcomp3() const
{
    SERIAL_W(fmt::format("iqcomp3 -b {:c}",rf_idx()));
    return 0;
}

int32_t air_3268::intdldcw(const double pwr,const bool en) const
{
    SERIAL_W(fmt::format("intdldcw -b {:c} {:d} {:d}",rf_idx(),int32_t(pwr * 10),(en ? 1 : 0)));
    return 0;
}

int32_t air_3268::rxulg(const double gain) const
{
    SERIAL_W(fmt::format("rxulg {:d}",uint32_t(gain)));
    return 0;
}

int32_t air_3268::ulil(double &pwr) const
{
    vector<double> pwrs;
...
int32_t air_3268::ulil(vector<double> &pwrs) const
{
    string read;
    string separator = "\r\n";
    size_t pos[2] = {0,0};
...
int32_t air_3268::mpa(const bool en) const
{
    SERIAL_W(fmt::format("mpa {:d}",en ? 1 : 0));
    return 0;
}

int32_t air_3268::set_sn(const string &sn)
{
...
int32_t air_3268::open_board()
{
    return 0;
}

int32_t air_3268::close_board()
{
...
int32_t air_3268::serial_write_read(serial_dev *serial,const std::string &w,std::string &r)
{
...
int32_t air_3268::serial_write(serial_dev *serial,const string &w)
{
    string r;
    return serial_write_read(serial,w,r);
}

int32_t air_3268::prepare_case(const ns_air_3268::cal_table_t &kase,const string freq_str,const bool is_exp)
{
