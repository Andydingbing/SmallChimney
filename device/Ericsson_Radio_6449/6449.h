#ifndef DEVICE_ERICSSON_RADIO_6449_H
#define DEVICE_ERICSSON_RADIO_6449_H
...
class API radio_6449 : public frontend
{
public:
    radio_6449();
    virtual ~radio_6449();
    ...
    ns_radio_6449::cal_file *data_base() const { return _cal_file; }
    ...
    int32_t pacm() const;
    int32_t txtype(const ns_radio_6449::tx_type_t &type) const;
    int32_t rxrfsw(const bool en_lna,const bool en_att);
    int32_t rxrfvga(const double att) const;
    int32_t rxrfvgaswp(const std::string &str,ns_radio_6449::data_f_rx_rf_vga *data = nullptr) const;
    int32_t rxagc(const bool en) const;
    int32_t rx(const uint64_t freq);
    int32_t rxtype(const ns_radio_6449::rx_type_t &type) const;
    ...
    int32_t prepare_case(const ns_radio_6449::cal_table_t &kase,const std::string freq_str,const bool is_exp);
...
protected:
    ...
    bool _is_att_en;
    serial_dev *_serial;
    ns_radio_6449::cal_file *_cal_file;
};
