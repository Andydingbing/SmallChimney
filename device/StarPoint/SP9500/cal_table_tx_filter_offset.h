#ifndef DEVICE_STARPOINT_SP9500_CAL_TABLE_TX_FILTER_OFFSET_H
#define DEVICE_STARPOINT_SP9500_CAL_TABLE_TX_FILTER_OFFSET_H
...
struct API data_f_tx_filter_offset : item_table_base::data_f_base_t
{
    double offset;
    double temp[4];

    data_f_tx_filter_offset();
};

struct data_m_tx_filter_offset
{
    float offset;
    float temp_5;
};
...
public:
    ...
    typedef data_m_tx_filter_offset data_m_t;
    ...
    uint32_t each_data_reception_columns() const OVERRIDE { return 7; }
