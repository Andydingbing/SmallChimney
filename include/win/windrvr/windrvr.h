...
#define WD_VER_STR  WD_PROD_NAME " v" WD_VERSION_STR \
        " Jungo (c) 1997 - 2010 Build Date: " __DATE__ \
...
#if defined(APPLE)
typedef IOPhysicalAddress PHYS_ADDR;
typedef IOPhysicalAddress DMA_ADDR; /*FIXME: Samyon*/
...
#define IOCTL_WD_CARD_REGISTER            WD_CTL_CODE(0x9c2)
...
#define IOCTL_WD_EVENT_REGISTER           WD_CTL_CODE(0x9c3)
...
#define IOCTL_WD_WATCH_PCI_START          WD_CTL_CODE(0x9c4)
