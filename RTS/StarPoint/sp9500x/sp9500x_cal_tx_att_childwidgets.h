#ifndef SP9500X_CAL_TX_ATT_CHILDWIDGETS_H
#define SP9500X_CAL_TX_ATT_CHILDWIDGETS_H
...
CONFIG_MODEL(Q_TX_Att_Config_Model,
             "TX-0-Output",
             "TX-0-IO",
             "TX-1")

class Q_TX_Att_Config_Delegate : public Q_Config_Table_Delegate
{
public:
    Q_TX_Att_Config_Delegate(QObject *parent = nullptr) :
...
class Q_TX_Att_Model : public QCalBaseModel
{
public:
    Q_TX_Att_Model(QObject *parent = nullptr) :
...
class Qwt_TX_Att_Data : public QwtCalData
{
public:
    Qwt_TX_Att_Data() { table = nullptr; }
...
class Cal_TX_Att_ChildWidgets
{
public:
    Cal_TX_Att_ChildWidgets(QWidget *parent = nullptr)
    {
        _parent = parent;

        Q_Cal_TX_Att_Widget *p = dynamic_cast<Q_Cal_TX_Att_Widget *>(_parent);
        ...
        configDelegate = new Q_TX_Att_Config_Delegate;
        configModel = new Q_TX_Att_Config_Model;
    ...
    Qwt_TX_Att_Data dataTX0_Output;
    Qwt_TX_Att_Data dataTX0_IO;
    Qwt_TX_Att_Data dataTX1;

    Q_TX_Att_Model modelTX0_Output;
    Q_TX_Att_Model modelTX0_IO;
    Q_TX_Att_Model modelTX1;

    Q_TX_Att_Config_Model *configModel;
    Q_TX_Att_Config_Delegate *configDelegate;
};

} // namespace NS_SP9500X

#endif // SP9500X_CAL_TX_ATT_CHILDWIDGETS_H
