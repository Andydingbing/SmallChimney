...
private slots:
    ...
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX0_ATT0,index / 4.0); }

    void on_comboBoxTX1Att0_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX1_ATT0,index / 4.0); }

    void on_comboBoxTX0Att1_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX0_ATT1,index / 4.0); }

    void on_comboBoxTX1Att1_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX1_ATT1,index / 4.0); }

    void on_comboBoxTX0Att2_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX0_ATT2,index / 4.0); }

    void on_comboBoxTX1Att2_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX1_ATT2,index / 4.0); }

    void on_comboBoxTX0Att3_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX0_ATT3,index / 4.0); }

    void on_comboBoxTX1Att3_activated(int index)
    { SP1403_R1A->set_att(sp1403_r1a::att_t::TX1_ATT3,index / 4.0); }
    ...
    { SP1403_R1A->set_tx0_sw1(sp1403_r1a::tx_sw1_t::_from_index(index)); }

    void on_comboBoxTX1Sw1_activated(int index)
    { SP1403_R1A->set_tx1_sw1(sp1403_r1a::tx_sw1_t::_from_index(index)); }

    void on_comboBoxTX0Sw2_activated(int index)
    { SP1403_R1A->set_tx0_sw2(sp1403_r1a::tx_sw2_t::_from_index(index)); }

    void on_comboBoxTX1Sw2_activated(int index)
    { SP1403_R1A->set_tx1_sw2(sp1403_r1a::tx_sw2_t::_from_index(index)); }

    void on_comboBoxTX0Sw3_activated(int index)
    { SP1403_R1A->set_tx0_sw3(sp1403_r1a::tx_sw3_t::_from_index(index)); }

    void on_comboBoxTX1Sw3_activated(int index)
    { SP1403_R1A->set_tx1_sw3(sp1403_r1a::tx_sw3_t::_from_index(index)); }

    void on_comboBoxTX0Sw4_activated(int index)
    { SP1403_R1A->set_tx0_sw4(sp1403_r1a::tx_sw4_t::_from_index(index)); }

    void on_comboBoxTX1Sw4_activated(int index)
    { SP1403_R1A->set_tx1_sw4(sp1403_r1a::tx_sw4_t::_from_index(index)); }

    void on_comboBoxTX0Sw5_activated(int index)
    { SP1403_R1A->set_tx0_sw5(sp1403_r1a::tx0_sw5_t::_from_index(index)); }

    void on_comboBoxTX1Sw5_activated(int index)
    { SP1403_R1A->set_tx1_sw5(sp1403_r1a::tx1_sw5_t::_from_index(index)); }

    void on_comboBoxTX0Sw6_activated(int index)
    { SP1403_R1A->set_tx0_sw6(sp1403_r1a::tx0_sw6_t::_from_index(index)); }

    void on_comboBoxTX1Sw6_activated(int index)
    { SP1403_R1A->set_tx1_sw6(sp1403_r1a::tx1_sw6_t::_from_index(index)); }

    void on_comboBoxTX0Sw7_activated(int index)
    { SP1403_R1A->set_tx0_sw7(sp1403_r1a::tx0_sw7_t::_from_index(index)); }

    void on_comboBoxTX0Sw8_activated(int index)
    { SP1403_R1A->set_tx0_sw8(sp1403_r1a::tx0_sw8_t::_from_index(index)); }

    void on_comboBoxTX0Sw9_activated(int index)
    { SP1403_R1A->set_tx0_sw9(sp1403_r1a::tx0_sw9_t::_from_index(index)); }

    void on_comboBoxTX0Sw10_activated(int index)
    { SP1403_R1A->set_tx0_sw10(sp1403_r1a::tx0_sw10_t::_from_index(index)); }

    void on_comboBoxTX0Sw11_activated(int index)
    { SP1403_R1A->set_tx0_sw11(sp1403_r1a::tx0_sw11_t::_from_index(index)); }

    void on_comboBoxTX0Sw12_activated(int index)
    { SP1403_R1A->set_tx0_sw12(sp1403_r1a::tx0_sw12_t::_from_index(index)); }
