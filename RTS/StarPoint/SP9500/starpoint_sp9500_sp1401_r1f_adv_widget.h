#ifndef STARPOINT_SP9500_SP1401_R1F_ADV_WIDGET_H
#define STARPOINT_SP9500_SP1401_R1F_ADV_WIDGET_H

#include "starpoint_sp9500_global.h"
#include "starpoint_sp9500_adf5355_dlg.h"

class Q_StarPoint_SP9500_SP1401_R1F_Adv_Widget : public Q_Widget
{
    Q_OBJECT

public:
    Q_StarPoint_SP9500_SP1401_R1F_Adv_Widget(QWidget *parent = nullptr);
    ~Q_StarPoint_SP9500_SP1401_R1F_Adv_Widget();
...
private:
    ...
    Ui::Q_StarPoint_SP9500_SP1401_R1F_Adv_Widget *ui;
};
