...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvTxLO1_clicked()
{
    ...
    if (!dlg_ADF5355[loIdx]) {
        ...
        dlg_ADF5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_TX_LO1")
                                           .arg(SP3301->rfu_idx())
                                           .arg(SP1401->rf_idx()));
    }
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvTxLO2_clicked()
{
    ...
    if (!dlg_ADF5355[loIdx]) {
        ...
        dlg_ADF5355[loIdx]->_sp1401_r1c = nullptr;
        dlg_ADF5355[loIdx]->loIdx = loIdx;
        dlg_ADF5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_TX_LO2")
                                           .arg(SP3301->rfu_idx())
                                           .arg(SP1401->rf_idx()));
    }
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvRxLO1_clicked()
{
    ...
    if (!dlg_ADF5355[loIdx]) {
        ...
        dlg_ADF5355[loIdx]->_sp1401_r1c = nullptr;
        dlg_ADF5355[loIdx]->loIdx = loIdx;
        dlg_ADF5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_RX_LO1")
                                           .arg(SP3301->rfu_idx())
                                           .arg(SP1401->rf_idx()));
    }
...
void Q_SP1401_R1A_Adv_Widget::on_pushButtonAdvRxLO2_clicked()
{
    ...
    if (!dlg_ADF5355[loIdx]) {
        ...
        dlg_ADF5355[loIdx]->_sp1401_r1c = nullptr;
        dlg_ADF5355[loIdx]->loIdx = loIdx;
        dlg_ADF5355[loIdx]->setWindowTitle(QString("R1A/B_ADF5355_RFU%1_RF%2_RX_LO2")
                                           .arg(SP3301->rfu_idx())
                                           .arg(SP1401->rf_idx()));
    }
