...
class Q_StarPoint_SP9500_SP1401_R1C_Adv_Widget : public Q_Widget
{
    Q_OBJECT

public:
    Q_StarPoint_SP9500_SP1401_R1C_Adv_Widget(QWidget *parent = nullptr);
    ~Q_StarPoint_SP9500_SP1401_R1C_Adv_Widget();
...
private:
    ...
    Ui::Q_StarPoint_SP9500_SP1401_R1C_Adv_Widget *ui;
};
