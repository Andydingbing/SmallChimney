...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvTXLO3_clicked()
{
    ...
    if (dlg_ADF5355[dlgIdx] == nullptr) {
        ...
        dlg_ADF5355[dlgIdx]->setWindowTitle(QString("R1C/D/E_ADF5355_RFU%1_RF%2_TX_LO3")
                                            .arg(SP3301->rfu_idx())
                                            .arg(SP1401->rf_idx()));
    }
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvTXLO2_clicked()
{
    ...
    if (dlg_ADF5355[dlgIdx] == nullptr) {
        ...
        dlg_ADF5355[dlgIdx]->setWindowTitle(QString("R1C/D/E_ADF5355_RFU%1_RF%2_TX_LO2")
                                            .arg(SP3301->rfu_idx())
                                            .arg(SP1401->rf_idx()));
    }
...
void Q_SP1401_R1C_Adv_Widget::on_pushButtonAdvRXLO1_clicked()
{
    ...
    if (dlg_ADF5355[dlgIdx] == nullptr) {
        ...
        dlg_ADF5355[dlgIdx]->setWindowTitle(QString("R1C/D/E_ADF5355_RFU%1_RF%2_RX_LO1")
                                            .arg(SP3301->rfu_idx())
                                            .arg(SP1401->rf_idx()));
    }
