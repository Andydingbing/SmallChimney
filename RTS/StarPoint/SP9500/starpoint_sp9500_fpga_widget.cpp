...
Q_StarPoint_SP9500_FPGA_Widget::Q_StarPoint_SP9500_FPGA_Widget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Q_StarPoint_SP9500_FPGA_Widget)
{
    ui->setupUi(this);
...
Q_StarPoint_SP9500_FPGA_Widget::~Q_StarPoint_SP9500_FPGA_Widget()
{
    delete ui;
}

void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonWriteK7_0_clicked()
{
    qint32 status = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonReadK7_0_clicked()
{
    qint32 status = 0;
    quint32 offset = ui->lineEditOffsetK7_0->text().toUInt(nullptr,16);
    quint32 data = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonWriteK7_1_clicked()
{
    qint32 status = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonReadK7_1_clicked()
{
    qint32 status = 0;
    quint32 offset = ui->lineEditOffsetK7_1->text().toUInt(nullptr,16);
    quint32 data = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonWriteS6_BAR0_clicked()
{
    qint32 status = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonReadS6_BAR0_clicked()
{
    qint32 status = 0;
    quint32 offset = ui->lineEditOffsetS6_BAR0->text().toUInt(nullptr,16);
    quint32 data = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonWriteS6_BAR1_clicked()
{
    qint32 status = 0;
    quint32 offset = ui->lineEditOffsetS6_BAR0->text().toUInt(nullptr,16);
    quint32 data = ui->lineEditDataS6_BAR0->text().toUInt(nullptr,16);
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonReadS6_BAR1_clicked()
{
    qint32 status = 0;
    quint32 offset = ui->lineEditOffsetS6_BAR0->text().toUInt(nullptr,16);
    quint32 data = 0;
...
void Q_StarPoint_SP9500_FPGA_Widget::on_pushButtonSetPathK7_0_clicked()
{
