...
class Q_StarPoint_SP9500_SP1401_R1A_Widget : public Q_Widget
{
    Q_OBJECT

public:
    Q_StarPoint_SP9500_SP1401_R1A_Widget(QWidget *parent = nullptr);
    ~Q_StarPoint_SP9500_SP1401_R1A_Widget();
...
private:
    Ui::Q_StarPoint_SP9500_SP1401_R1A_Widget *ui;
};
